...
- `web-app-security/`
  - revisão sintética S29 de trust boundary web/API, bloqueando lógica crítica e contexto de tenant controlados pelo client sem camada autoritativa
- `domain-governance-usage/`
  ...
  - suficiência S39 para comparar S36/S38 e manter expansão bloqueada enquanto a evidência ainda é pequena e heterogênea
- `execution-patterns/`
