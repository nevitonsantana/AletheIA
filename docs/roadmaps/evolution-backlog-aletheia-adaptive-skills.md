...
- **Status:** `in review`; official publishing remains gated pending a deliberate asset-publication strategy or documented acceptance of the warning.
...
- **Evidence:** `docs/reports/blume-asset-warning-readiness-s64.md`, `pnpm run docs:validate`.
