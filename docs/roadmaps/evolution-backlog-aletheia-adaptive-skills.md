...
- **Status:** `in review`; no further automatic translation is admissible from this scan.
...
- **Evidence:** `docs/reports/public-language-residual-classification-s78.md`.
