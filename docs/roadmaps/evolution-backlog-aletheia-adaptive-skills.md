...
| P11-R6 Documentation-health projection | P11 integration map | `delivered` as validation triage; publishing gated | S55, S56 | S55 proved an isolated static documentation shell can build from existing Markdown; S56 classified validation/source-coverage gaps and keeps publishing, automatic mutation and documentation-health projection blocked pending source mapping. |
