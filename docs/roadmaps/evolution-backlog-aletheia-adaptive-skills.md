...
- **Status:** `in review`; no deployment or workflow changes are included.
...
- **Evidence:** `docs/reports/blume-publication-readiness-decision-s66.md`, `pnpm run docs:validate`, `pnpm run docs:build`.
