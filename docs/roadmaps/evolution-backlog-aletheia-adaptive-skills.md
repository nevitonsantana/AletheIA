...
- **Status:** `in review`; visual/Kanban PT-BR labels remain a separate follow-up because they may be communication labels rather than accidental language drift.
...
- **Evidence:** `docs/roadmaps/knowledge-governance-implementation-prep.md`.
