...
Temporal planning documents and track-evolution records. These answer "where is AletheIA going and why?"

**What NOT to put here:** completed pilot reports (those go in `pilots/`) or normative specs (those go in `contracts/`).
