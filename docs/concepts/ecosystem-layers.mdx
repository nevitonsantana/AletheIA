...
![Illustrated map of the AletheIA and Adaptive Skills ecosystem](../assets/ecosystem-map-illustration.png)

:::note[Illustrations and source-backed status]
These illustrations help readers build a mental model of the ecosystem. They are explanatory references, not evidence that every depicted capability is implemented. The status and boundaries below remain authoritative.
:::
...
The following illustrations make each part of the ecosystem easier to recognize. Read the accompanying text for the current, partial, deferred, and evidence-gated status of each layer.

### AletheIA Core

![Illustrated AletheIA Core governance model](../assets/layer-aletheia-core.png)

### Human layer

![Illustrated Human Layer](../assets/layer-human.png)
...
![Illustrated Agent Layer](../assets/layer-agent.png)

### Knowledge and continuity

![Illustrated Knowledge layer](../assets/layer-knowledge.png)

### Runtime and safety

![Illustrated Runtime and Safety layer](../assets/layer-runtime-safety.png)

### Observability

![Illustrated Observability layer](../assets/layer-observability.png)

### Evolution signals and outcomes

![Illustrated Evolution Signals layer](../assets/layer-evolution-signals.png)

![Illustrated Outcomes layer](../assets/layer-outcomes.png)
