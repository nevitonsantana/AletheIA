...
- **Active:** S51 — Restart Package learning and context hygiene compatibility review.
- **Next dependency path:** S51 is reviewing the smallest manual Restart Package compatibility extension from S50; future implementation slices require separate review while S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback and comparative metrics remain blocked.
...
1. Complete S51 as a manual Restart Package compatibility review; do not implement learning automation, memory writeback, new schemas or Adaptive Skills changes from the S50 source alone.
...
- **Date:** 2026-07-14
- **Evidence baseline:** AletheIA `b8d6acd` after PR #366 closed S50; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S51 opens the first bounded S50 follow-up as manual Restart Package compatibility review
