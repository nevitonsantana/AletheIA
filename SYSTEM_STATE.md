...
- **Active:** none.
- **Next dependency path:** S73 delivered the first public concept English-normalization slice; future normalization should continue in small reviewed public-doc slices; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `e50a567` after PR #411 delivered S73; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S73 closure after core concept English normalization merge
