...
- **Active:** none.
- **Next dependency path:** S76 delivered ADR-007 language normalization; future normalization should continue in small reviewed public-doc slices; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `7df4495` after PR #417 delivered S76; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S76 closure after ADR-007 language normalization merge
