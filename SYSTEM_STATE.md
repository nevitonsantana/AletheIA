...
- **Active:** S73 — Core concept English normalization.
- **Next dependency path:** S73 normalizes two public concept pages to the official English docs language; future normalization should continue in small reviewed public-doc slices; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `8da2bd4` after PR #410 closed S72; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S73 starts public-doc English normalization after S72 policy
