...
- **Active:** S74 — Launch Kit English normalization.
- **Next dependency path:** S74 normalizes the public Launch Kit to English only; future normalization should continue in small reviewed public-doc slices; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `272eb2e` after PR #412 closed S73; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S74 continues public-doc English normalization after S73
