...
1. If desired, rerun the manual Pages workflow and smoke-test that duplicate titles and raw Markdown routes are no longer visible in the public artifact.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `4d062b7` after PR #404 delivered S69; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S69 closure after Blume output guard merge
