...
- **Active:** none.
- **Next dependency path:** S74 delivered Launch Kit English normalization; future normalization should continue in small reviewed public-doc slices; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `57e3b6b` after PR #413 delivered S74; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S74 closure after Launch Kit English normalization merge
