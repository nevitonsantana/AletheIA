...
- **Active:** S71 — Docs language and ADR navigation audit.
- **Next dependency path:** S71 records a small docs language audit and fixes Blume ADR navigation metadata; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
1. Review S71 navigation/language audit, then decide a separate language-normalization slice before translating public docs.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `4adb193` after PR #406 recorded S70; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** Public docs review found mixed language and ADR navigation/order issues
