...
- **Date:** 2026-07-25
- **Evidence baseline:** AletheIA `5a0fcf2` after PR #461 reconciled the S86 `insufficient_evidence` decision; Adaptive Skills locally available `origin/main` at `2de5dde`
- **Review trigger:** S86 status reconciliation after PR #461 merged
