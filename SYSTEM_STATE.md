...
- **Active:** none.
- **Next dependency path:** choose the next backlog slice only when a real source-backed trigger exists; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
1. Select the next backlog slice only from a real source-backed trigger; do not add sources, collectors, dashboards, scoring, ranking, S18 metrics or runtime behavior.
