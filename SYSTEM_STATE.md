...
- **Active:** S76 — ADR-007 language normalization.
- **Next dependency path:** S76 normalizes residual Portuguese terms in public ADR-007; future normalization should continue in small reviewed public-doc slices; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `f295a78` after PR #416 closed S75; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S76 continues public-doc English normalization after S75
