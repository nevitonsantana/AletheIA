...
- **Active:** S72 — Public docs English language policy.
- **Next dependency path:** S72 records English as the official public-doc language before any translation/normalization slices; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
1. After S72, normalize mixed-language public docs in small reviewed slices; preserve historical evidence unless explicitly reviewed.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `9d8b7c6` after PR #408 closed S71; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** User decision that English is the official public documentation language
