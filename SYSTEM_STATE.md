...
- **Active:** none.
- **Next dependency path:** S80 resolved the S78 public-language residual categories with explicit editorial decisions; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `7cf0307` after PR #428 delivered S80; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S80 closure after PR #428 merged the public-language residual resolution
