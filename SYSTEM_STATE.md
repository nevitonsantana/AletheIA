...
- **Active:** none.
- **Next dependency path:** S71 delivered Blume ADR navigation metadata and a language-coherence audit; the next docs slice should decide the official public-doc language before translation; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
1. Decide the official public-doc language before translating or normalizing mixed-language pages; preserve historical evidence unless explicitly reviewed.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `4ef4803` after PR #407 delivered S71; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S71 closure after docs language and ADR navigation audit merge
