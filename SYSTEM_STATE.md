...
- **Active:** none.
- **Next dependency path:** S72 delivered English as the official public-doc language; future normalization should happen in small reviewed public-doc slices; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
1. Normalize mixed-language public reader-facing docs in small reviewed slices; preserve historical evidence unless explicitly reviewed.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `ee68fe8` after PR #409 delivered S72; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S72 closure after public documentation language policy merge
