...
- **Active:** none.
- **Next dependency path:** S75 delivered architecture flow language normalization; future normalization should continue in small reviewed public-doc slices; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `8c3868c` after PR #415 delivered S75; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S75 closure after architecture flow language normalization merge
