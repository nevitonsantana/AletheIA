...
- **Active:** S80 — Public language residual resolution.
- **Next dependency path:** S80 resolves the S78 language residuals for historical learning records, pilot/local guides and localized visual labels with explicit editorial decisions; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `0691d28` after Dependabot PRs #422, #423 and #424 merged; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S80 resolves the residual public-language categories classified by S78
