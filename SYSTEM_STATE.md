...
- **Active:** S75 — Architecture flow language normalization.
- **Next dependency path:** S75 removes a remaining Portuguese flow label from the public architecture concept page; future normalization should continue in small reviewed public-doc slices; automatic publishing on merge remains blocked pending a separate decision; S18, Runtime 2.0, dashboards, collectors, automatic learning classification, memory writeback, Adaptive Skills mutation and comparative metrics remain blocked.
...
- **Date:** 2026-07-15
- **Evidence baseline:** AletheIA `a484612` after PR #414 closed S74; Adaptive Skills `acba2de` after PR #72 dependency maintenance
- **Review trigger:** S75 continues public-doc English normalization after S74
